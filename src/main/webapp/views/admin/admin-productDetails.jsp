          ...
          <div class="content-wrapper">
            <!-- Content -->
				<div class="container-xxl flex-grow-1 container-p-y">
             	<h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboards /</span> Products - Details</h4>
					      ...
					      <div class="card-body">
					        ...
					        <form id="formValidationExamples" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
					          ...
					          <div class="col-md-6 fv-plugins-icon-container">
					            ...
					            <input type="text" id="formValidationName" class="form-control notEdit" value="${product.productName}" name="productName" readonly="readonly">
					          <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>
					          ...
					          <div class="col-md-6 fv-plugins-icon-container">
						          ...
						          <div class="input-group">
		                            ...
		                            <input type="text" id="formValidationName" class="form-control notEdit" value="${product.category.cateName}" name="" readonly="readonly">
		                          </div>
	                          </div>
					          ...
					          <div class="col-md-6 fv-plugins-icon-container">
					            <label class="form-label" for="formValidationName">Stoke</label>
						          <div class="input-group">
			                        <input type="number" class="form-control notEdit" aria-label="Dollar amount (with dot and two decimal places)" value="${product.stoke}" name="stoke" readonly="readonly">
			                      </div>
					          </div>
	                          ...
	                          <div class="col-md-6 fv-plugins-icon-container">
		                          <div>
			                        ...
			                        <textarea class="form-control notEdit" id="exampleFormControlTextarea1" rows="3" name="" readonly="readonly">${product.description}</textarea>
			                      </div>
			                  </div>
			                  ...
			                  <div class="col-md-6 fv-plugins-icon-container">
		                          <div>
			                        ...
			                        <textarea class="form-control notEdit" id="exampleFormControlTextarea1" rows="3" name="" readonly="readonly">${product.information}</textarea>
			                      </div>
			                  </div>
					          ...
					          <div class="col-12">
					            ...
					            <a style="display: contents;" id="discardLink" href="<c:url value="/admin/products"/>"><button onclick="discardAndRedirect()" type="reset" name="resetButton" class="btn bg-label-danger">Back</button></a>
					          </div>
