			...
			<div class="col-lg-12 text-center">
				<div class="breadcrumb__text">
					...
					<div class="breadcrumb__option">
						<a href="/WebFinalProject/views/home/Home.jsp">Home</a> <span>Shop</span>
					</div>
				</div>
			</div>
		</div>
								...
								<div class="latest-prdouct__slider__item">
									<a href="#" class="latest-product__item">
										<div class="latest-product__item__pic">
											<img
												src="/WebFinalProject/templates/img/latest-product/lp-1.jpg"
												alt="">
										</div>
										...
										<div class="latest-product__item__pic">
											<img
												src="/WebFinalProject/templates/img/latest-product/lp-2.jpg"
												alt="">
										</div>
										<div class="latest-product__item__text">
											<h6>Crab Pool Security</h6>
										...
										<div class="latest-product__item__pic">
											<img
												src="/WebFinalProject/templates/img/latest-product/lp-3.jpg"
												alt="">
										</div>
										<div class="latest-product__item__text">
											<h6>Crab Pool Security</h6>
