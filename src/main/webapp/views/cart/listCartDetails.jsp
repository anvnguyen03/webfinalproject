			...
			<div class="col-lg-12 text-center">
				<div class="breadcrumb__text">
					...
					<div class="breadcrumb__option">
						<a href="/WebFinalProject/views/home/listCategoryToHome.jsp">Home</a> <span>Shopping Cart</span>
					</div>
				</div>
			</div>
		</div>
						...
						<tbody>
							<tr>
								<td class="shoping__cart__item"><img
									src="/WebFinalProject/templates/img/cart/cart-1.jpg" alt="">
							...
							<tr>
								<td class="shoping__cart__item"><img
									src="/WebFinalProject/templates/img/cart/cart-2.jpg" alt="">
							...
							<tr>
								<td class="shoping__cart__item"><img
									src="/WebFinalProject/templates/img/cart/cart-3.jpg" alt="">
