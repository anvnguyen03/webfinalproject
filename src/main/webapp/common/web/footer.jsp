...
<footer class="footer-section footer-bg" style="margin-top: 20px">
                ...
                <div class="footer-widget-single-item footer-widget-color--golden" data-aos="fade-up"  data-aos-delay="600">
                    ...
                    <div class="footer-about">
                        ...
                        <address class="address">
                            <span>Address: Số 1 VVN, Linh Chiểu, Thủ Đức</span> 
            ...
            <div class="row justify-content-between align-items-center align-items-center flex-column flex-md-row mb-n6">
                ...
                <div class="col-auto mb-6">
                    <div class="footer-payment">
                        <div class="image">
                            <img src="<c:url value="/templates/assets/images/company-logo/payment.png"/>" alt="">
                        </div>
                    </div>
                </div>
            </div>
