...
<meta charset="UTF-8">
<title>Login</title>
<link rel="stylesheet" href='<c:url value="/templates/css/login_style.css" />' type="text/css">
</head>
<body>
	<div class="row">
		<div class="col">
	...
	<form class="form" action="login" method="post">
		<div class="container">
			...
			<p class="p">
				Don't have an account? <a href="<c:url value="/register" />"><span class="span">Sign Up</span></a>
